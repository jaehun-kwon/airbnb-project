...
public class DateData {
	...
	public HashMap<String, Integer> today_info(DateData dateData) {
		HashMap<String, Integer> today_Data = new HashMap<String, Integer>();
		...
		else if(today_year > search_year) {today = -1;}
		else if(today_year == search_year && today_month > search_month ) {today = -1;}
		
		search_month = search_month-1; 
		
		HashMap<String, Integer> before_after_calendar = before_after_calendar(search_year,search_month);
	...
	private HashMap<String, Integer> before_after_calendar(int search_year, int search_month){
		HashMap<String, Integer> before_after_data = new HashMap<String, Integer>();
